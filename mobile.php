...
<form action="view.php" method="post">
        ...
        <div class="div">
            ...
            <button type="submit"  name="m1" class="button">Order Now</button>
        </div></div>
        <div class="mtwo">
            <div class="div">
            ...
            <button type="submit"  name="m2" class="button">Order Now</button>  
        </div></div>
        <div class="mthree">
            <div class="div">
            ...
            <button type="submit" name="m3" class="button">Order Now</button>   
        </div></div>
        <div class="mfour">
            <div class="div">
            ...
            <button type="submit" name="m4" class="button">Order Now</button>   
        </div></div>
        <div class="mfive">
            <div class="div">
            ...
            <button type="submit" name="m5" class="button">Order Now</button>        
        </div></div>
        <div class="msix">
            <div class="div">
                ...
                <button type="submit" name="m6" class="button">Order Now</button>    
            </div></div>
            <div class="mseven">
                <div class="div">
                ...
                <button type="submit" name="m7" class="button">Order Now</button>     
            </div></div>
            <div class="meight">
                <div class="div">
                ...
                <button type="submit" name="m8" class="button">Order Now</button>    
            </div></div>
            <div class="mnine">
                <div class="div">
                ...
                <button type="submit" name="m9" class="button">Order Now</button>    
            </div></div>
            <div class="mten">
                <div class="div">
                ...
                <button type="submit" name="m10" class="button">Order Now</button>    
            </div></div>
            <div class="mone1">
                <div class="div">
                    ...
                    <button type="submit" name="m11" class="button">Order Now</button>     
                </div></div>
                <div class="mtwo1">
                    <div class="div">
                    ...
                    <p class="p"><b>&#8377;10,999  </b><strike>&#8377;16,999</strike></p> 
                    <button type="submit" name="m12" class="button">Order Now</button>    
                </div></div>
                <div class="mthree1">
                    <div class="div">
                    ...
                    <button type="submit" name="m13" class="button">Order Now</button>    
                </div></div>
                <div class="mfour1">
                    <div class="div">
                    ...
                    <p class="p"><b>&#8377;11,999  </b><strike>&#8377;13,999</strike></p>
                    <button type="submit" name="m14" class="button">Order Now</button>     
                </div></div>
                <div class="mfive1">
                    <div class="div">
                    ...
                    <button type="submit" name="m15" class="button">Order Now</button>    
                </div></div>
                <div class="msix1">
                    <div class="div">
                        ...
                        <p class="p"><b>&#8377;11,999  </b><strike>&#8377;13,999</strike></p>
                        <button type="submit" name="m16" class="button">Order Now</button>     
                    </div></div>
                    <div class="mseven1">
                        <div class="div">
                        ...
                        <button type="submit" name="m17" class="button">Order Now</button>     
                    </div></div>
                    <div class="meight1">
                        <div class="div">
                        ...
                        <h4 class="h4">4500 mah Battery</h4>
                        <p class="p"><b>&#8377;11,999  </b><strike>&#8377;13,999</strike></p>
                        <button type="submit" name="m18" class="button">Order Now</button>     
                    </div></div>
                    <div class="mnine1">
                        <div class="div">
                        ...
                        <button type="submit" name="m19" class="button">Order Now</button>    
                    </div></div>
                    <div class="mten1">
                        <div class="div">
                        ...
                        <button type="submit" name="m20" class="button" >Order Now</button>    
                    </div></div>
</form>
    </body>
</html>